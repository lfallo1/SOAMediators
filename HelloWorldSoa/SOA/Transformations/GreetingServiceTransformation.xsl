   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            <oracle-xsl-mapper:schema location="../WSDLs/GreetingService.wsdl"/>
            <oracle-xsl-mapper:rootElement name="Request" namespace="http://www.lancefallon.org"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            <oracle-xsl-mapper:schema location="../WSDLs/GreetingService.wsdl"/>
            <oracle-xsl-mapper:rootElement name="Response" namespace="http://www.lancefallon.org"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [FRI FEB 03 19:47:17 EST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:Response>
         <ns0:greetingMessage>
            <xsl:value-of select="concat (&quot;Hello, &quot;, /ns0:Request/ns0:firstName, &quot; &quot;, /ns0:Request/ns0:lastName )"/>
         </ns0:greetingMessage>
      </ns0:Response>
   </xsl:template>
</xsl:stylesheet>
